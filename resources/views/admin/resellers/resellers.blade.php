...
@section('scripts')
<script type="text/javascript" src="{{asset('js/meetpat_resellers.js')}}"></script>
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var get_table_data = function(search_term, page) {            
            ...
            $.get("/api/meetpat-admin/get-resellers",
             {api_token: auth_token, page: page, search_term: search_term}, function(data, textStatus,jqXHR) {
                ...
                if(Object.keys(data).length && data.data.length) {
                    for(var key in data.data) {
                        ...
                        if(data.data[key].reseller.active == true) {
                        $("#tableBody").append(
