...
$(document).ready(function() {
    ...
    pond_element.addEventListener("FilePond:removefile", e => {
        ...
        $.post("/api/meetpat-client/update/custom-metrics/handle-remove-upload?file_id=" + $("#fileId").val() + "&user_id=" + $("#userId").val(), function(e) {}).done(function(e) {
            check_fields();
    ...
    FilePond.setOptions({
        ...
        server: {
            url: site_url,
            process: {
                url: "/api/meetpat-client/update/custom-metrics/handle-file-upload?user_id=" + $("#userId").val(),
                method: "POST",
                withCredentials: !1,
                headers: {},
                onerror: function(e) {
        ...
        $("form#update-custom-audience").submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "/api/meetpat-client/update/custom-metrics/handler",
                type: "POST",
                data: t,
                success: function(e) {
