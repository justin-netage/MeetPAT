...
class DataVisualisationController extends Controller
{
    ...
    public function index()
    {
        ...
        $records = \MeetPAT\AudienceFilter::where([['user_id', '=', $user->id], ['type', '=', 'all_records']])->get();
    ...
    public function get_location_data(Request $request) {
        ...
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/get-location-data?" . $query_params));
    ...
    public function get_demographic_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/get-demographic-data?" . $query_params));
    ...
    public function get_assets_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/get-assets-data?" . $query_params));
    ...
    public function get_financial_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/get-financial-data?" . $query_params));
    ...
    public function get_custom_variable_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/get-custom-variables?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records_count = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/count?" . $query_params));
    ...
    public function get_municipalities(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/municipality?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/province?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/age-group?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/gender?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/population-group?" . $query_params));
    ...
    public function get_home_owner(Request $request) 
    {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/home-ownership-status?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/vehicle-ownership-status?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/income-bucket?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/employer?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/risk-category?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/lsm-group?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/property-valuation-bucket?" . $query_params));
    ...
    public function get_property_count_bucket(Request $request)
    {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/property-count-bucket?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/directorship-status?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/citizen-vs-resident?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/generation?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/marital-status?" . $query_params));
    ...
    public function get_area(Request $request) {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/area?" . $query_params));
    ...
    public function get_primary_property_type(Request $request) {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("https://ancient-depths-staging.herokuapp.com/records/primary-property-type?" . $query_params));
