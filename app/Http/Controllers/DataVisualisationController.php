...
class DataVisualisationController extends Controller
{
    ...
    public function get_location_data(Request $request) {
        ...
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/get-location-data?" . $query_params));
    ...
    public function get_demographic_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/get-demographic-data?" . $query_params));
    ...
    public function get_assets_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/get-assets-data?" . $query_params));
    ...
    public function get_financial_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/get-financial-data?" . $query_params));
    ...
    public function get_custom_variable_data(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/get-custom-variables?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records_count = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/count?" . $query_params));
    ...
    public function get_municipalities(Request $request) {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/municipality?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/province?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/age-group?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/gender?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/population-group?" . $query_params));
    ...
    public function get_home_owner(Request $request) 
    {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/home-ownership-status?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/vehicle-ownership-status?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/income-bucket?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/employer?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/risk-category?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/lsm-group?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/property-valuation-bucket?" . $query_params));
    ...
    public function get_property_count_bucket(Request $request)
    {
        ...
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/property-count-bucket?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/directorship-status?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/citizen-vs-resident?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/generation?" . $query_params));
    ...
    {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/marital-status?" . $query_params));
    ...
    public function get_area(Request $request) {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/area?" . $query_params));
    ...
    public function get_primary_property_type(Request $request) {
        $query_params = http_build_query($request->all());
        $records = json_decode(file_get_contents("http://docker.dataassociate.co.za:8080/records/primary-property-type?" . $query_params));
